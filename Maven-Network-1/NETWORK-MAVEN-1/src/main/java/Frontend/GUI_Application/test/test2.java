...
public class test2 extends JPanel {
    ...
    private boolean isUserExists(String username, String email) {
        ...
        String directoryPath = "C:\\Users\\CSM\\Desktop\\Maven-Network-1\\NETWORK-MAVEN-1\\src\\main\\java\\Frontend\\GUI_Application\\database";
    ...
    private void initComponents() {
        ...
        //======== panel ========
        {
            ...
            //---- label8 ----
            label8.setIcon(new ImageIcon("C:\\Users\\CSM\\Desktop\\Maven-Network-1\\logokhtn1.png"));
                        ...
                        .addGroup(panelLayout.createParallelGroup()
                            .addGroup(panelLayout.createSequentialGroup()
                                ...
                                .addGroup(panelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                    .addComponent(label2)
                                    .addComponent(usernameTF, GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE))
                                .addGap(6, 6, 6)
                                .addGroup(panelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                    .addComponent(emailTF, GroupLayout.DEFAULT_SIZE, 0, Short.MAX_VALUE)
                                    .addComponent(label4))
                                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(panelLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
