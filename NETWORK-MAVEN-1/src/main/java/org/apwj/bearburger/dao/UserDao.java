...
public class UserDao
{
    ...
    public Boolean insertRow(String username, String email, String pass, String gender) {

        Timestamp ts = new Timestamp(System.currentTimeMillis());
        String insertQuery = "INSERT INTO users (username, email, pass, gender, reg_date) " +
                "VALUES" + "('" + username + "', '" + email + "', '" + pass + "', '"  + "', '" + gender + "', '" + ts + "');";
    ...
    public void updateUser(int userId, String pass, String gender) {
        this.jdbcTemplate.update("update users set pass = '" + pass + "',  '"
